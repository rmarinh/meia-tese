...
\thesissubtitle{A Privacy-Preserving Approach} % Your thesis title, this is used in the title, print it elsewhere with \tsubtitle
...
\keywords{Multi-Agent Systems, Large Language Models, Software Testing, Privacy, Security, GDPR} % Please define up to 6 keywords that better describe your work, print it elsewhere with \keywordnames
