...
\usetikzlibrary{positioning,calc} % Required for relative node positioning and coordinate calculations in TiKZ
...
\thesistitle{Automated Software Testing using Multi-Agent Systems (MAS) and Large Language Models (LLMs)} % Your thesis title, this is used in the title, print it elsewhere with \ttitle

\thesissubtitle{A Multi-Agent Approach with Golden Examples and Black-Box Observation} % Your thesis title, this is used in the title, print it elsewhere with \tsubtitle

\author{Rui Marinho} % Your name, this is used in the title page, print it elsewhere with \authorname

\studentnumber{1171602}

%\subjectarea{Área de Especialização} % Specialisation area, used in the title page, print it elsewhere with \areaname

\supervisor{Constantino Martins} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\committeepresident{[To be defined]} % Name of the president of the evaluation committee, print it elsewhere with \presidentname

\committeemembers{[To be defined upon thesis defense scheduling]} % Name of the evaluation committee members (up to four), print it elsewhere with \committee

\keywords{Multi-Agent Systems, Large Language Models, Automated Test Generation, Golden Examples, Black-Box Testing, Few-Shot Learning} % Please define up to 6 keywords that better describe your work, print it elsewhere with \keywordnames

\university{\href{https://www.ipp.pt}{Polit\'ecnico do Porto}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname

\department{\href{https://www.isep.ipp.pt}{Instituto Superior de Engenharia do Porto (ISEP)}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
...
\input{ch2/chapter2}  % Systematic Review of the Literature
\input{ch3/chapter3}  % Data Collection and Pre-processing
\input{ch4/chapter4}  % Methods and Tools
\input{ch5/chapter5}  % Solution Implementation
\input{ch6/chapter6}  % Experimentation and Discussion
\input{ch7/chapter7}  % Data Protection, Security and Ethics
\input{ch8/chapter8}  % Conclusions and Future Work
