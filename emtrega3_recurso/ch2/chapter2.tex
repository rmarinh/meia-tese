...
\keyword{meia-style.cls} -- this is an important file. It is the class file that tells \LaTeX{} how to format the thesis. 
...
Another example illustration is included in Figure~\ref{fig:ramos2008}, which shows a comic about thesis writing.

\begin{figure}[t]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{ch2/assets/Ramos2008.png}
\caption[Ambient-intelligence Arquitecture]{When defining a caption, inside the square brackets is the short title that will appear in the \emph{List of Figures}; The second part in the curly brackets should contain the longer and more descriptive caption text; Image from \autocite{ramos2008}.}
\label{fig:ramos2008}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{ch2/assets/Marreiros2010.png}
\caption{Relationship between number of arguments and number of simulations \autocite{marreiros2010}.}
\label{fig:marreiros2010}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{ch2/assets/Faria2009.png}
\caption{Graphical visualization of the result \autocite{faria2009}.}
\label{fig:faria2009}
\end{figure}
...
The Table of Contents should only list the sections to three (3) levels. A \verb|chapter{}| is level zero (0). A \verb|\section{}| is level one (1) and so a \verb|\subsection{}| is level two (2). In your thesis it is likely that you will even use a \verb|subsubsection{}|, which is level three (3). The depth to which the Table of Contents is formatted is set within \file{meia-style.cls}. If you need this changed, you can do it in \file{main.tex}.
